...
DEFAULT_APV_PREPRINTED_LAYOUT = {
    ...
    'texts': {
        ...
        'checked_by':  {'text': 'Checked by:',  'x': 340, 'y': 720, 'fontSize': 10, 'bold': False, 'hidden': False},
...
def _clean_texts(raw):
    """Layout-only signature texts (prepared_by/checked_by/approved_by)."""
    raw = raw if isinstance(raw, dict) else {}
    d = DEFAULT_APV_PREPRINTED_LAYOUT['texts']
    out = {}
    for k in TEXT_KEYS:
