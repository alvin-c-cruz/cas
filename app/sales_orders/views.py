...
def job_order_list():
    ...
    # The sell-side document chain, SO -> DR -> SI, each ONE query for the whole
    # list (owner request 2026-09-12, the Purchase Requests list's PO/RR/AP/CD
    # columns mirrored). No collection column: collection is money, and this page
    # is unpriced (owner, same day). Never a per-row property here.
    from app.sales_orders.chain_links import dr_links_for_so_ids, si_links_for_so_ids
