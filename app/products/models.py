...
Per-company optional module. R-03 Slice 1 adds track_inventory/costing_method/
standard_cost/reorder_level -- additive, nullable-except-track_inventory columns
gated by the `inventory` module. See
