/* JV pre-printed layout designer (clone of APV; no journalEntry block) -- the thin drag/serialize/save layer.
...
(function () {
  ...
  saveBtn.addEventListener('click', async () => {
    ...
    try {
      const resp = await fetch('/journal-entries/print-layout', {
        method: 'POST',
