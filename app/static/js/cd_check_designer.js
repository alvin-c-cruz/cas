/* CDV CHECK layout designer (clone of SI/CRV) -- the thin drag/serialize/save layer.
...
(function () {
  ...
  saveBtn.addEventListener('click', async () => {
    ...
    try {
      const resp = await fetch((canvas.dataset.saveUrl || '/cash-disbursements/check-layout'), {
        method: 'POST',
