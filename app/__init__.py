...
def create_app(config_name=None):
    ...
    from app.permission_requests.models import PermissionChangeRequest  # noqa: F401
    from app.users.models import User
    ...
    from app.accounts_payable import amendment_models  # noqa: F401
    ...
    from app.fixed_asset_disposal.models import FixedAssetDisposal  # noqa: F401
    ...
    from app.production_runs.models import ProductionRun, ProductionRunMaterial  # noqa: F401
    ...
    from app.withholding_certificates.views import withholding_certificates_bp
    ...
    from app.stock_adjustments.views import stock_adjustments_bp
    ...
    from app.fixed_asset_disposal.views import fixed_asset_disposal_bp
    ...
    from app.manufacturing_departments.views import manufacturing_departments_bp
    from app.production_runs.views import production_runs_bp
    ...
    app.register_blueprint(withholding_certificates_bp)
    ...
    app.register_blueprint(fixed_asset_disposal_bp)
    ...
    app.register_blueprint(manufacturing_departments_bp)
    app.register_blueprint(production_runs_bp)
